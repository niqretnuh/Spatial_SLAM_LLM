...
#settingsPath = "/dockerMount/docker/slamSettings_room1.yaml"
#settingsPath = "/dockerMount/docker/slamSettings_iphone.yaml"
settingsPath = "/dockerMount/docker/slamSettings_alumni.yaml"
